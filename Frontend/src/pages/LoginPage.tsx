      ...
      >
        <GlassCard className="p-8" hover={false}>
          ...
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-white mb-2">Welcome back, job hero.</h2>
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <motion.button
                className="flex items-center justify-center px-4 py-2 border border-white/10 rounded-xl bg-white/5 text-white hover:bg-white/10 transition-colors duration-200"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
